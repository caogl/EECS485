...
('sportslover', 'Paul', 'Walker', 'paulRocks', 'sportslover@hotmail.com'),
('traveler', 'Rebecca', 'Travolta', 'john', 'rebt@explorer.org'), 
('spacejunkie', 'Bob', 'Spacey', 'bobRocks', 'bspace@spacejunkies.net');

INSERT INTO Album (title, created , lastupdated, username) VALUES
('I love sports', NOW(), NOW(), 'sportslover'),
('I love football', NOW(), NOW(), 'sportslover'),
('Around the World', NOW(), NOW(), 'traveler'),
('Cool Space Shots', NOW(), NOW(), 'spacejunkie'); 
