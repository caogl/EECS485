...
<div class = "div2">
   <form method ="POST" action="/ymneig/pa4/album/edit?id={$albumID}">
	<table>
	   <tr>
	   <td>Album Name:</td>
...
{while $i<$numPics}
	...
	<td>
            <form method = "POST" action = "/ymneig/pa4/album/edit?id={$albumID}">
 	    <a href = "/ymneig/pa4/pic?id={$picIDs[$i]}"><img src="/static/pictures/{$pics[$i]}" style="width:304px;height:228px"></a>
...
{/while}
	...
	<td class = "upload" colspan = "3" align="center">
		<form enctype="multipart/form-data" action="/ymneig/pa4/album/edit?id={$albumID}" method="POST">
