...
<div class = "header">
  ...
  {for $i = 0 to $num-1}      
         <tr>
	  <td><a href="/ymneig/pa4/album?id={$albumIDs[$i]}">{$albumNames[$i]}</a></td>
	  <td>{$albumAccess[$i]}</td>
	  <td><a href="/ymneig/pa4/album/edit?id={$albumIDs[$i]}">Edit</a></td>	 
          <td><form method="POST" action= "/ymneig/pa4/albums/edit?username={$username}">
   ...
   {/for}        
	  <tr>
             <td>	     
             <form method="POST" action= "/ymneig/pa4/albums/edit?username={$username}">
