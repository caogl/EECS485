...
<p>
	...
	{$b = $index+1}
	{if $index > 0}
		<a href = "/ymneig/pa2/pic?id={$pics[$a]}">&lt&ltPrev</a>
		&nbsp;&nbsp;&nbsp;
	{/if}
	{if $index<$numPics-1}
		<a href = "/ymneig/pa2/pic?id={$pics[$b]}">Next>></a>
	{/if}
</p>
{if $permission eq 1} 
	<p><a align="left" href="/ymneig/pa2/album/edit?id={$albumid}">Back to Edit Album</a></p>
{/if}
<p><a align="left" href="/ymneig/pa2/album?id={$albumid}">Back to Album</a></p>
</body>
{/block}
